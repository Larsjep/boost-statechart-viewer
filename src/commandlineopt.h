...
llvm::cl::list<string> includeFiles("I", llvm::cl::desc("Specify the location of included files"),  llvm::cl::value_desc("Source location")); //option -I must be there at least once
